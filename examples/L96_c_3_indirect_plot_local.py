...
def plot_measure(states):
    ...
    plt.tight_layout()
    plt.savefig(cwd + '/L96_c_3_indirect_local_invariant_measure.pdf')
    plt.close()
...
def plot_data():
    ...
    fin = 'L96_c_3_indirect_local_g.pkl'
    ...
    plt.tight_layout()
    cwd = os.getcwd()
    plt.savefig(cwd + '/L96_c_3_indirect_local_data.pdf')

if __name__ == "__main__":
    print("Number of cpu : ", multiprocessing.cpu_count())
    print('Start plotting:')
    start = time.time()
    fin = 'L96_c_3_indirect_local_u.pkl'
